  ...
  return (
    <BrowserRouter>
      ...
      <div className="Navdropdown-dividercontainer d-flex justify-content-end">
        <button
          className="btn btn-secondary Navdropdown-toggle"
          type="button"
          id="NavdropdownMenuButton1"
        ...
        <ul
          ...
          aria-labelledby="NavdropdownMenuButton1"
          font="wheat, cursive, sans-serif"
        >
          <li>
            <Link className="Navdropdown-item" to="/">
              Home
            </Link>
          </li>
          <li>
            <Link className="Navdropdown-item" to="/contact">
              Contact
            </Link>
          </li>
        </ul>
